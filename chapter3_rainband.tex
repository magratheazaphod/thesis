...
\section{To-do list}
\textbf{Problems: 1) what do the letters mean in the A-D test definition? 2) check number of iterations. 3) Perhaps we should define better what a rainband is in dynamical terms? 4) should include Ping Zhao paper on dynamics - potentially very important. 5) Check that section references are OK}
...
\section{Conclusion}
	...
	IMPORTANT: The purpose of this chapter is not to speculate on the atmospheric dynamics responsible for these changes, but rather to provide the best possible account of past changes based on which other researchers can develop their theories.
...
\caption{Difference in yearly mean rainfall between 1980-2007 and 1951-1979. The South Flood-North Drought pattern is visible between 110-125$^{\circ}$E and 22-42$^{\circ}$N over mainland China. Changes significant at a 95\%/99\% level are marked with single/double cross-hatches respectively.}
\label{fig:f31}
\end{figure}
