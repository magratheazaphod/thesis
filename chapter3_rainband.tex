...
\section{Introduction} %SHOULD ADD OLD VERSION OF THIS INTRODUCTION FROM WHEN IT USED TO BE MORE COMPLETE.
	...
	The yearly mean change in rainfall rate between 100-142$^{\circ}$ E and 20-48$^{\circ}$ N is shown in Figure ~\ref{changes_2d_nojet}, as well as the zonal mean. The ``South Flood-North Drought'' refers in particular to a meridional dipole between zonal bands of rainfall change over eastern China (110-125$^{\circ}$ E and 22-42$^{\circ}$ N), where most of China's population resides. In the yearly mean, changes in northern China between 35-40$^{\circ}$ N are significant at a 95 \% confidence level. Changes in central and southern China are not significant at a 95\% confidence level, but we will subsequently show that particular phases of Meiyu season show substantial changes in this region. Pronounced local shifts are also visible in Taiwan, South Korea and parts of Japan. In this paper, we focus on eastern China. It is likely that changes during particular months have larger human impact than a change in cumulative yearly total. Therefore, we subsequently investigate what particular intervals of the East Asian monsoon contribute most to the South Flood-North Drought.
