...
\begin{itemize}
	...
	\item $M_2$ - Intensity-weighted centroid of daily precipitation latitude;
...
\item ``Pre-Meiyu'' season (121-160, May 1-June 9), during which rainfall and front intensity steadily increase (56\% occurrence, 25.5 mm day$^{-1}$ mean);

\item Meiyu season (161-200, June 10-July 19) when a remarkable 7-degree northward shift in mean rainband latitude occurs over the course of several weeks, and rainband frequency and intensity peaks (66\% occurrence, 28.3 mm day$^{-1}$ mean; 

\item Post-Meiyu season (201-273, July 20-September 30), during which rainbands are less common than the spring rains (42\% occurrence) but double rainbands are much more common (28\% chance of observing a secondary rainband if a primary rainband is occurred); 

\item the ``Fall Rains'' (274-320, October 1-November 16), when mean rainband latitude shifts back southward from its northern maximum of 30$^\circ$N and rainband frequency decreases to just 27\%. 
...
%% NEW PARAGRAPH - SIMPLY DESCRIBES THE YEARLY CUMULATIVE SOUTH FLOOD-NORTH DROUGHT
	The yearly mean change in rainfall rate between 100-142$^{\circ}$ E and 20-48$^{\circ}$ N is shown in Figure~\ref{fig:f31}. The ``South Flood-North Drought'' refers in particular to a meridional dipole between zonal bands of rainfall change over eastern China (110-125$^{\circ}$ E and 22-42$^{\circ}$ N), where most of China's population resides. Pronounced local shifts are also visible in Taiwan, South Korea and parts of Japan. This work focuses on eastern China. Annual changes in northern China between 35-40$^{\circ}$ N are significant at a 95 \% confidence level, whereas changes in central and southern China are not. However, there are substantial changes in central and southern China rainfall during particular Meiyu stages, as shown in Figure~\ref{fig:changes}a and discussed below.
...
\caption{Details on the application of quality control (QC) criteria to secondary rainbands. Type I and Type II fits are explained in greater detail in Section 3.5.}
\centering
...
\begin{tabular}{ l c c c c}
	 ...
	 \textbf{Time Period} 							& $\textbf{K-S}$ & $\textbf{A-D}$ 		& $\textbf{K-S}$ & $\textbf{A-D}$ \\
	 \hline
...
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=40pc]{Figures/ch3/S1}
...
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=40pc]{Figures/ch3/S2}
...
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=40pc]{Figures/ch3/S4}
...
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=42pc]{Figures/ch3/S3}
...
%%FIGURE 3.6 Hovmöller diagram of Meiyu latitude occupancy, 1951-2007. Produced by MATLAB scripts meiyufig1.m and meiyustats_compact.m.
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=32pc]{Figures/ch3/meiyu_hovmoller}
