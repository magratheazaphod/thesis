...
\section{To-do list}
\textbf{Problems: 3) explain dynamics of rainbands better? 5) Check that section references are OK 6) sort out use of precipitation versus rainband 8) Just for my purposes, wouldn't it be good to know what the overall pattern of rainfall change is between 1979-1993 and 1994-2007? 9) Probably need to search through the Zhou Tianjun library of papers and make sure I give credit where necessary}
