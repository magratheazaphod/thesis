...
\begin{figure}
\centering
\noindent\includegraphics[width=48pc]{Figures/ch4/CGT_2}
...
%% FIGURE 4.3 - Zonal wind anomalies between composites
\begin{figure}
\centering
\noindent\includegraphics[width=48pc]{Figures/ch4/CGT_4}
\caption{Frouth CGT plot}
\label{fig:cgt4}
\end{figure}

%% FIGURE 4.5 Climatology of rainfall stages including rainfall, jet and most likely rainband configuration, and longitudinal averages.
\begin{figure}
\centering
...
%% FIGURE 4.6 - 2D spatial distribution of change showing a) full year b) Pre-Meiyu and c) Post-Meiyu
\begin{figure}
\centering
...
%% FIGURE 4.7 - Changes in jet mean between 1951-1979 and 1980-2007 + scatter plots of jet and rainband monthly anomalies.
\begin{figure}[htbp]
\centering
...
%% FIGURE 4.8 - Temporal autocorrelation of the jet used to demonstrate the choice of block size for averaging.
\begin{figure}[htbp]
\centering
