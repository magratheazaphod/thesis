...
%% MAKE SMALL TABLE HERE %%

% potentially show years that overlap between the two data sets?

%All-Asia EOF1
% July +: 1970, 1987, 1998, 2002, 2007
% July -: 1959, 1973, 1976, 1978, 1994
% August +: 1958, 1965, 1993, 1998, 2005
% August -: 1973, 1978, 1984, 1994, 2006

%All-Nepal Monsoon Rainfall
% July +: 1984, 1985, 1988, 1998, 2007
% July -: 1971, 1973, 1991, 1993, 2006
% August +: 1961, 1962, 1966, 1988, 1998
% August -: 1972, 1984, 1986, 2004, 2006
...
\section{Composites of All-Asia EOF1 in JRA-55}
	...
	These patterns strongly resembles the Circumglobal Teleconnection (hereafter CGT) studied in \citet{Ding2005a}. \citet{Branstator2002} originally found that, in regions of strong meridional temperature gradient such as East Asia, a pattern with zonal wavenumber 5 can extend around the globe, with the tropospheric jet serving as a waveguide favoring the zonal propagation of storms. Their Figure 1c in that text is very similar to our Figure ~\ref{fig:cgt2}. A further clue that our pattern of variability corresponds to the CGT is that geopotential height anomalies associated with All-Asia EOF1 are barotropic throughout the Northern Hemisphere except over India ~\ref{fig:cgt2}. This agrees with the modes studied in both \citet{Branstator2002} and \citet{Ding2005a}.
	
	Another way of showing the same pattern is to look at meridional wind, which has the advantage of being 0 in its zonal mean \citep{Ding2007}, such that wavelike processes are apparent without additional filtering. Figure ~\ref{fig:cgt3} shows V200 for the July and August composites. The number of lobes is easily counted to be a wavenumber 5 pattern. We conclude that the wavetrain associated with All-Asia EOF1 and the \citet{Ding2005a} CGT must indeed be the same pattern.
	
%% NEED A PARAGRAPH DISCUSSING HOW JRA-55 COMPOSITES SUPPORT HYPOTHESIS FROM CHAPTER 2
	...
	...from the differences between positive and negative Julys, it is reasonable to suggest that All-Asia EOF1 may have an isotopic signature along the Yangtze River Valley - possibly greater depletion in positive All-Asia EOF1 years due to increased long range transport of moisture from the Bay of Bengal. TALK ABOUT ISOTOPIC RECORD FROM CHANGSHA??
	
	...also definite implications about speleothems - this helps to clarify that changes in moisture transport to the southeastern Tibetan Plateau are definitely associated with overall changes in monsoon variability, and can help to strengthen our confidence in records like Tianmen and Xiaobailong (CITES)
	...
	In the case of panel Figure ~\ref{fig:cgt5}d we have not include the positive and negative composite estimates separately because they are rather similar to each other. During the positive composite the magnitude of southward water vapor transport northward in southern China is up to 250 kg m$^{-1}$ s$^{-1}$, but only about 170 kg m$^{-1}$ s$^{-1}$ in negative years with essentially none across the Yunnan Plateau.  In addition, the eastward moisture transport in positive composite years across the Yunnan Plateau is roughly 100 kg m$^{-1}$ s$^{-1}$, and practically zero in negative composite years. Therefore, moisture transport across the Yunnan Plateau seems to be contributing significantly to the anomalously strong southerly monsoon flow in southern China.
...
%% for this table and the next, need to figure out how to do multirow

%can potentially make it so that years that are shared between composites are bolded or something.
...
%% FIGURE 4.3 - Meridional wind anomalies between composites
\begin{figure}
\centering
...
%% FIGURE 4.4 - Zonal wind anomalies between composites
\begin{figure}
\centering
...
%% FIGURE 4.5 - Series of additional plots suggesting dynamics of CGT
\begin{figure}
\centering
...
%% FIGURE 4.6 - Positive and negative composites of low-level specific humidity and winds
\begin{figure}
\centering
...
%% FIGURE 4.7 - Positive and negative composites of mid-tropospheric ascent and winds
\begin{figure}
\centering
