...
\subsection{Historical Precipitation and Temperature Records}
	...
	We rely on the University of Delaware precipitation data set (UDEL), available at $.5^{\circ}$ by $.5^{\circ}$ resolution for the years 1900-2014. For the testing of statistical significance we use the same years as available in JRA-55, 1958-2013, which also feature higher station coverage than the first half of the \nth{20} century.
